"use strict";/* sspg v.0.1.5 built: Mon Aug 25 2014 10:21:00 GMT-0400 (EDT) */var undertone = function(){}; (function(window, myWin){
var m,q=window;
function r(a){var b=typeof a;if("object"==b)if(a){if(a instanceof Array)return"array";if(a instanceof Object)return b;var c=Object.prototype.toString.call(a);if("[object Window]"==c)return"object";if("[object Array]"==c||"number"==typeof a.length&&"undefined"!=typeof a.splice&&"undefined"!=typeof a.propertyIsEnumerable&&!a.propertyIsEnumerable("splice"))return"array";if("[object Function]"==c||"undefined"!=typeof a.call&&"undefined"!=typeof a.propertyIsEnumerable&&!a.propertyIsEnumerable("call"))return"function"}else return"null";else if("function"==
b&&"undefined"==typeof a.call)return"object";return b}function aa(a){var b=r(a);return"array"==b||"object"==b&&"number"==typeof a.length}function s(a){return"string"==typeof a}function ba(a){var b=typeof a;return"object"==b&&null!=a||"function"==b}function t(a){return a[ca]||(a[ca]=++da)}var ca="closure_uid_"+Math.floor(2147483648*Math.random()).toString(36),da=0;function v(a,b){function c(){}c.prototype=b.prototype;a.gb=b.prototype;a.prototype=new c}
function ea(a){function b(){d=!0;for(var a=0;a<e.length;a++)c(e[a].fn,e[a].args||[],e[a].ctxt);e=[]}function c(c,b,d){try{d||(d=a.c),c.apply(d,b||[])}catch(k){}}var d=!1,e=[];a.c.addEventListener?a.f.addEventListener("DOMContentLoaded",function(){b()},!1):function(){if(!a.f.getElementsByTagName("body")[0])setTimeout(arguments.callee,0);else if(a.f.uniqueID||!a.f.expando){var c=a.f.createElement("document:ready");try{c.doScroll("left"),b()}catch(d){setTimeout(arguments.callee,0)}}}();return{ready:function(f,
h,g){a.n=a.f.getElementsByTagName("body")[0];if(a.friendlyFrame||!d&&!a.Ea){var k=!0;try{var l=a.f.createElement("div");a.n.appendChild(l);b();a.n.removeChild(l)}catch(u){k=!1}d=k}d?c(f,h,g):e[e.length]={fn:f,ctxt:g,args:h}}}}
function fa(a){this.c=this.n=this.f=null;this.Fa="c-";this.Ga="BACKGROUND";this.Ja="__utc__=1";this.aa=function(){return this.B&&this.f.domain&&this.f.domain!=this.c.location.host?!0:!1};this.i="__UT__";this.g=this.B=!1;if("undefined"==typeof window.Da||null==window.Da)try{this.c=window,this.f=a?"undefined"!=typeof window.parent.document?window.parent.document:window.document:window.document}catch(b){this.c=window,this.f=window.document}else this.c=window.lb,this.f=window.Da;this.n=this.f.getElementsByTagName("body")[0];
if(this.B=-1!=this.c.navigator.appVersion.indexOf("MSIE")?!0:!1)for(var c=-1,d=document.createElement("b");d.innerHTML="\x3c!--[if gt IE "+ ++c+"]>1<![endif]--\x3e",0<d.innerHTML;);try{this.g=this.c&&this.c.mraid||window&&window.mraid||a&&window&&window.top&&window.top.mraid?!0:!1}catch(e){this.g=!1}}
function ga(a){var b=a||{};this.Va=function(a,b){var e="[object Array]"===Object.prototype.toString.apply(a);e||(a=a.replace(/^\s|\s$/g,""));if("undefined"!=typeof a&&0<a.length){var f=0;a=e?a:[a];for(var h=!0,g=function(){f++;f===a.length&&b&&b(h)},e=function(){h=!1;g()},k=0;k<a.length;k++)this.R(a[k],g,e,e)}else b&&b(e)};this.R=function(a,b,e,f){if(""!=a){var h=new Image;e&&(h.onabort=e);f&&(h.onerror=f);b&&(h.onload=b);h.src=a}else b()};this.Wa=function(a,d,e,f,h){a=a.replace(/^\s|\s$/g,"");h=
h||!1;e=e||!1;if(a){var g=b.f.createElement("script");g.type="text/javascript";g.onreadystatechange=g.onload=function(){var a=g.readyState;!e||h&&h()||("undefined"==typeof g.addEventListener||a)&&!/loaded/.test(a)||(setTimeout(e,0),e=!1,g.onreadystatechange=g.onload=function(){})};d=b.c.setTimeout(function(){f()},d);g.src=a;b.n.appendChild(g);g.async=!1;return d}return null}}
function ha(a){a=String(a);if(/^\s*$/.test(a)?0:/^[\],:{}\s\u2028\u2029]*$/.test(a.replace(/\\["\\\/bfnrtu]/g,"@").replace(/"[^"\\\n\r\u2028\u2029\x00-\x08\x0a-\x1f]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,"]").replace(/(?:^|:|,)(?:[\s\u2028\u2029]*\[)+/g,"")))try{return eval("("+a+")")}catch(b){}throw Error("Invalid JSON string: "+a);}function ia(){this.M=void 0}
function w(a,b,c){switch(typeof b){case "string":ja(b,c);break;case "number":c.push(isFinite(b)&&!isNaN(b)?b:"null");break;case "boolean":c.push(b);break;case "undefined":c.push("null");break;case "object":if(null==b){c.push("null");break}if("array"==r(b)){var d=b.length;c.push("[");for(var e="",f=0;f<d;f++)c.push(e),e=b[f],w(a,a.M?a.M.call(b,String(f),e):e,c),e=",";c.push("]");break}c.push("{");d="";for(f in b)Object.prototype.hasOwnProperty.call(b,f)&&(e=b[f],"function"!=typeof e&&(c.push(d),ja(f,
c),c.push(":"),w(a,a.M?a.M.call(b,f,e):e,c),d=","));c.push("}");break;case "function":break;default:throw Error("Unknown type: "+typeof b);}}var x={'"':'\\"',"\\":"\\\\","/":"\\/","\b":"\\b","\f":"\\f","\n":"\\n","\r":"\\r","\t":"\\t","\x0B":"\\u000b"},ka=/\uffff/.test("\uffff")?/[\\\"\x00-\x1f\x7f-\uffff]/g:/[\\\"\x00-\x1f\x7f-\xff]/g;
function ja(a,b){b.push('"',a.replace(ka,function(a){if(a in x)return x[a];var b=a.charCodeAt(0),e="\\u";16>b?e+="000":256>b?e+="00":4096>b&&(e+="0");return x[a]=e+b.toString(16)}),'"')}
function la(a){function b(){try{y+l[2]in g?g.addEventListener(y+l[1],function(){c.apply(this,arguments)},1):g.addEventListener?(a.addEventListener(u[0],e,1),a.addEventListener(u[1],d,1)):g.attachEvent&&(g.attachEvent("onfocusin",e),g.attachEvent("onfocusout",d))}catch(b){}}function c(){g[y+l[2]]?d():e()}function d(){f(2);h.call(this,"hidden")}function e(){f(1);h.call(this,"visible")}function f(a){if(a)for($=1==a?n:z,a=$.length;a--;)$[a]()}function h(a){"function"==typeof a&&p.push(a);var b=p.length;
if(b)if(y)for(;b--;)p[b].call(this,g[y+l[0]]);else for(;b--;)p[b].call(this,a)}var g=a.document,k=["webkit","ms","o","moz","khtml"],l=["VisibilityState","visibilitychange","Hidden"],u=["focus","blur"],n=[],z=[],p=[],$=[],y="";return{s:function(){a:if(!y){var a,c;for(a=0;c=k[a++];)if(c+l[2]in g){y=c;break a}}b()},Xa:function(a){"function"==typeof a&&n.push(a)},ib:function(a){"function"==typeof a&&z.push(a)}}}
function ma(){fa.call(this,!0);this.Z=this.Q=this.cb=null;this.Ea=!1;this.timeEngaged=this.timeViewed=0;this.timeViewStarted=-1;this.FORMAT=this.FORMAT||"";this.timeEngagementStarted=-1;this.isEngaged=this.isViewed=!1;this.G=null;this.da=1500E3;this.ka=!0;this.ignoredEvents={yt_video_loaded:1,yt_video_start:1,yt_video_playing:1,yt_video_resume:1,yt_video_pause:1,yt_video_stopped:1,yt_video_firstQuartile:1,yt_video_midpoint:1,yt_video_thirdQuartile:1,yt_video_complete:1,yt_video_volume_changed:1,yt_video_ended:1,
yt_video_mute:1,yt_video_unmute:1,yt_video_click_thru:1,yt_video_rewind:1,yt_video_videoreplay:1,yt_video_playerReady:1,video_loaded:1,video_start:1,video_playing:1,video_resume:1,video_pause:1,video_stopped:1,video_firstQuartile:1,video_midpoint:1,video_thirdQuartile:1,video_complete:1,video_volume_changed:1,video_ended:1,video_mute:1,video_unmute:1,video_click_thru:1,video_rewind:1,video_videoreplay:1,video_playerReady:1,ready:1,start:1,interaction:1,autoclose:1,close:1,ERROR:1};this.ignoredElements=
{CLOSE_BUTTON:1};this.T={};this.Y=!1;this.O={};this.m=null;this.F=1E4;this.u="";this.D=!1;this.pa="br";this.r=function(){return window.top.innerHeight||window.top.document.documentElement.clientHeight};this.na=function(){return window.top.innerWidth||window.top.document.documentElement.clientWidth};this.startTime=function(a,b){this[a]||(this[b]=Math.floor(new Date/1E3),this[a]=!0)};this.la=function(a,b,c){this[a]&&(this[a]=!1,this[c]+=Math.floor(new Date/1E3)-this[b])};this.X=function(){this.startTime("isViewed",
"timeViewStarted")};this.ma=function(){this.la("isViewed","timeViewStarted","timeViewed")};this.Ua=function(){this.la("isEngaged","timeEngagementStarted","timeEngaged")};this.N=function(){this.G&&this.c.clearTimeout(this.G);this.G=null};this.P=function(a){return!!this.ignoredEvents[a]};this.ja=function(a){return!!this.ignoredElements[a]}}v(ma,fa);
function na(a,b,c,d,e){this.a=new ma;if(e&&(e.waitForDOMLoaded&&(this.a.Ea=e.waitForDOMLoaded),void 0!=typeof e.iloc&&(this.a.pa=e.iloc),e.forceMRAID&&(this.a.g=!0),void 0!=typeof e.friendlyFrame&&(this.a.friendlyFrame=e.friendlyFrame),"undefined"!=typeof e.pubWidth)){var f=parseInt(e.pubWidth.toString());0<f&&(this.a.cb=f)}this.j=function(b,c){var k=this.a.timeEngaged,d=this.a.timeViewed,e=(new Date).getTime(),f=Math.floor(e/1E3),g=b.replace(this.a.Fa,"");if(a&&b&&3<b.length){c||(c=b!=g?this.a.Ga:
this.a.FORMAT);this.a.ignoredEvents[b]||this.a.ignoredEvents[g]||this.a.ignoredElements[c]||(-1==b.indexOf("REDIRECT")&&-1==g.indexOf("REDIRECT")&&this.a.N(),this.a.Y||(this.a.Y=!0,this.j("interaction",this.a.FORMAT)));this.a.hb&&(k+=f-this.a.timeEngagementStarted);this.a.isViewed&&(d+=f-this.a.timeViewStarted);if(isNaN(k)||0>k)k=0;if(isNaN(d)||0>d)d=0;var h=f=0,l=0,g=["all",g],Q=["all",c];this.K.R(a+b+"&eid="+c+"&ts="+k+"&tv="+d+"&cb2="+(new Date).getTime());if(null!=this.a.m)for(l=0;l<g.length;l++)if("undefined"!=
typeof this.a.m[g[l]])for(h=0;h<Q.length;h++)if("undefined"!=typeof this.a.m[g[l]][Q[h]])for(f=0;f<this.a.m[g[l]][Q[h]].length;f++){var Pa=this.a.m[g[l]][Q[h]][f].replace(/%elementid%/g,c).replace(/%eventname%/g,b).replace(/%randomnumber%/g,e);this.K.R(Pa)}null!=this.a.Z&&this.a.Z(b,c,k,d)}};this.info=function(a,b,c){a={clickBase:a,message:this.a.i+"Info",clickTags:b,encodeClickUrl:this.a.ka,iloc:this.a.pa};for(var k in c)a[k]||(a[k]=c[k]);return a};this.ta=function(){if(this.a.u)var a=this,b=0,c=
null,k=function(){var d;!a.a.D&&"undefined"!=typeof window.PUBLISHER_FIX_LOADED&&window.PUBLISHER_FIX_LOADED?(a.a.D=!0,null!=c&&a.a.c.clearTimeout(c),c=null,a.qa(),d=!0):d=!1;!d&&100*++b<=a.a.F&&setTimeout(k,100)},c=this.K.Wa(this.a.u,this.a.F,k,function(){b=a.a.F;a.j("ERROR","LOAD_PF_"+a.a.u);a.end()},function(){return a.a.D})};this.Ma=function(){this.a.N();this.sendFormatMessage("close");this.sendFormatMessage("scroll");this.close();this.a.Y||this.j("autoclose",this.a.FORMAT)};this.sendFormatMessage=
function(a,b){this.a.T.postMessage&&""!=a&&("undefined"==typeof b&&(a=this.a.i+a),this.a.T.postMessage(a,"*"))};this.handleMessage=function(a){if(a&&"object"==typeof a&&a.q)if(a=a.q,a.data==this.a.i+"ready"){if(this.j("ready",this.a.FORMAT),a.source){var k=this.info(b,c,{adConfig:this.a.c.ut_adConfig,isMRAID:this.a.g,expandHeight:this.a.h}),d=[];w(new ia,k,d);k=d.join("");this.a.T=a.source;this.sendFormatMessage(k,!1)}}else{try{k=ha(a.data)}catch(e){return}if(this.a.g&&k.data&&k.message&&k.message==
this.a.i+"MRAID")for(d in k.data)if("function"==typeof mraid[d]){a="array"==typeof k.data[d]?k.data[d]:[k.data[d]];try{mraid[d].apply(null,a)}catch(f){this.j("ERROR","MRAID_METHOD_"+d)}}else this.j("ERROR","MRAID_METHOD_"+d);k.data&&k.data.target&&k.data.target.id&&0<k.data.target.id.length&&this.j(k.message.replace(this.a.i,""),k.data.target.id)}};this.start=function(){this.a.u&&!this.a.D&&this.ta()};this.end=function(){};this.V=function(){function a(){mraid.addEventListener("viewableChange",function(){mraid.isViewable()&&
b.start&&b.start()})}var b=this,k=mraid.getState();"expanded"==k||"default"==k?mraid.isViewable()?b.start&&b.start():a():mraid.addEventListener("ready",a)};this.qa=function(){try{var a=this;if(a.a.u&&!a.a.D)a.ta();else if(d){var b=[],k=0;try{k=this.a.na()}catch(c){}d.mobile&&d.mobile.length&&768>k?b=d.mobile:d.alternate&&d.alternate.length&&768<=k?b=d.alternate:d.mobile||d.alternate||(b=d);0<b.length?a.K.Va(b,function(){a.domReady.ready(function(){a.a.g?a.V():a.start&&a.start()})}):a.domReady.ready(function(){a.a.g?
a.V():a.start&&a.start()})}else a.domReady.ready(function(){a.a.g?a.V():a.start&&a.start()})}catch(e){}};if(e){"undefined"!=typeof e.trackingDebugFunction&&(this.a.Z=e.trackingDebugFunction);"undefined"!=typeof e.closeDebugFunction&&(this.a.Q=e.closeDebugFunction);"undefined"!=typeof e.encodeClickUrl&&(this.a.ka=!!e.encodeClickUrl);"undefined"==typeof e.autoCloseTimePeriod||isNaN(e.autoCloseTimePeriod)||(this.a.da=parseInt(e.autoCloseTimePeriod.toString()));"undefined"==typeof e.publisherFixTimePeriod||
isNaN(e.publisherFixTimePeriod)||(this.a.F=parseInt(e.publisherFixTimePeriod.toString()));"undefined"!=typeof e.utPatchURL&&e.utPatchURL&&(this.a.u=e.utPatchURL.toString());for(var h in{ignoredElements:1,ignoredEvents:1})if(e[h]&&"object"==typeof e[h])for(var g in e[h])this.a[h][g]=1;if(e.thirdPartyTrackers&&"object"==typeof e.thirdPartyTrackers){this.a.m={};for(var k in e.thirdPartyTrackers)if(f=e.thirdPartyTrackers[k],this.a.m[k]=this.a.m[k]||{},f&&"object"==typeof f)for(var l in f)this.a.m[k][l]=
f[l].concat()}}this.K=new ga(this.a);this.domReady=new ea(this.a);this.O=la(this.a.c);this.O.s();this.P=function(a){return this.a.P(a)};this.ja=function(a){return this.a.ja(a)};this.La=function(a){this.O&&this.O.Xa(a)};this.ready=function(a,b,k){this.domReady.ready(a,b,k)};this.xa=function(){var a=this;a.a.N();a.a.G=a.a.c.setTimeout(function(){a.Ma()},a.a.da)}}
function oa(a){if(!pa.test(a))return a;-1!=a.indexOf("&")&&(a=a.replace(qa,"&amp;"));-1!=a.indexOf("<")&&(a=a.replace(ra,"&lt;"));-1!=a.indexOf(">")&&(a=a.replace(sa,"&gt;"));-1!=a.indexOf('"')&&(a=a.replace(ta,"&quot;"));return a}var qa=/&/g,ra=/</g,sa=/>/g,ta=/\"/g,pa=/[&<>\"]/;function ua(a,b){return a<b?-1:a>b?1:0}var A,va,B,wa;function xa(){return q.navigator?q.navigator.userAgent:null}wa=B=va=A=!1;var C;
if(C=xa()){var ya=q.navigator;A=0==C.indexOf("Opera");va=!A&&-1!=C.indexOf("MSIE");B=!A&&-1!=C.indexOf("WebKit");wa=!A&&!B&&"Gecko"==ya.product}var za=A,D=va,E=wa,F=B;function Aa(){var a=q.document;return a?a.documentMode:void 0}var G;
a:{var H="",I;if(za&&q.opera)var Ba=q.opera.version,H="function"==typeof Ba?Ba():Ba;else if(E?I=/rv\:([^\);]+)(\)|;)/:D?I=/MSIE\s+([^\);]+)(\)|;)/:F&&(I=/WebKit\/(\S+)/),I)var Ca=I.exec(xa()),H=Ca?Ca[1]:"";if(D){var Ea=Aa();if(Ea>parseFloat(H)){G=String(Ea);break a}}G=H}var Fa={};
function J(a){var b;if(!(b=Fa[a])){b=0;for(var c=String(G).replace(/^[\s\xa0]+|[\s\xa0]+$/g,"").split("."),d=String(a).replace(/^[\s\xa0]+|[\s\xa0]+$/g,"").split("."),e=Math.max(c.length,d.length),f=0;0==b&&f<e;f++){var h=c[f]||"",g=d[f]||"",k=RegExp("(\\d*)(\\D*)","g"),l=RegExp("(\\d*)(\\D*)","g");do{var u=k.exec(h)||["","",""],n=l.exec(g)||["","",""];if(0==u[0].length&&0==n[0].length)break;b=ua(0==u[1].length?0:parseInt(u[1],10),0==n[1].length?0:parseInt(n[1],10))||ua(0==u[2].length,0==n[2].length)||
ua(u[2],n[2])}while(0==b)}b=Fa[a]=0<=b}return b}var Ga=q.document,Ha=Ga&&D?Aa()||("CSS1Compat"==Ga.compatMode?parseInt(G,10):5):void 0;function Ia(){}var Ja=0;m=Ia.prototype;m.key=0;m.v=!1;m.ha=!1;m.s=function(a,b,c,d,e,f){if("function"==r(a))this.ra=!0;else if(a&&a.handleEvent&&"function"==r(a.handleEvent))this.ra=!1;else throw Error("Invalid listener argument");this.C=a;this.wa=b;this.src=c;this.type=d;this.ia=!!e;this.U=f;this.ha=!1;this.key=++Ja;this.v=!1};
m.handleEvent=function(a){return this.ra?this.C.call(this.U||this.src,a):this.C.handleEvent.call(this.C,a)};function Ka(a,b){for(var c in a)b.call(void 0,a[c],c,a)}var La="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function Ma(a,b){for(var c,d,e=1;e<arguments.length;e++){d=arguments[e];for(c in d)a[c]=d[c];for(var f=0;f<La.length;f++)c=La[f],Object.prototype.hasOwnProperty.call(d,c)&&(a[c]=d[c])}}var Na=!D||D&&9<=Ha,Oa=D&&!J("9");
!F||J("528");E&&J("1.9b")||D&&J("8")||za&&J("9.5")||F&&J("528");E&&!J("8")||D&&J("9");var K=Array.prototype,Qa=K.indexOf?function(a,b,c){return K.indexOf.call(a,b,c)}:function(a,b,c){c=null==c?0:0>c?Math.max(0,a.length+c):c;if(s(a))return s(b)&&1==b.length?a.indexOf(b,c):-1;for(;c<a.length;c++)if(c in a&&a[c]===b)return c;return-1},Ra=K.forEach?function(a,b,c){K.forEach.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=s(a)?a.split(""):a,f=0;f<d;f++)f in e&&b.call(c,e[f],f,a)};
function Sa(a){var b=a.length;if(0<b){for(var c=Array(b),d=0;d<b;d++)c[d]=a[d];return c}return[]}function Ta(a,b,c){return 2>=arguments.length?K.slice.call(a,b):K.slice.call(a,b,c)}function L(a,b){this.type=a;this.currentTarget=this.target=b}L.prototype.W=!1;L.prototype.defaultPrevented=!1;L.prototype.preventDefault=function(){this.defaultPrevented=!0};function Ua(a){Ua[" "](a);return a}Ua[" "]=function(){};function M(a,b){a&&this.s(a,b)}v(M,L);m=M.prototype;m.target=null;m.relatedTarget=null;
m.offsetX=0;m.offsetY=0;m.clientX=0;m.clientY=0;m.screenX=0;m.screenY=0;m.button=0;m.keyCode=0;m.charCode=0;m.ctrlKey=!1;m.altKey=!1;m.shiftKey=!1;m.metaKey=!1;m.q=null;
m.s=function(a,b){var c=this.type=a.type;L.call(this,c);this.target=a.target||a.srcElement;this.currentTarget=b;var d=a.relatedTarget;if(d){if(E){var e;a:{try{Ua(d.nodeName);e=!0;break a}catch(f){}e=!1}e||(d=null)}}else"mouseover"==c?d=a.fromElement:"mouseout"==c&&(d=a.toElement);this.relatedTarget=d;this.offsetX=F||void 0!==a.offsetX?a.offsetX:a.layerX;this.offsetY=F||void 0!==a.offsetY?a.offsetY:a.layerY;this.clientX=void 0!==a.clientX?a.clientX:a.pageX;this.clientY=void 0!==a.clientY?a.clientY:
...
m.preventDefault=function(){M.gb.preventDefault.call(this);var a=this.q;if(a.preventDefault)a.preventDefault();else if(a.returnValue=!1,Oa)try{if(a.ctrlKey||112<=a.keyCode&&123>=a.keyCode)a.keyCode=-1}catch(b){}};var N={},O={},P={},R={};
function S(a,b,c,d,e){if(b)if("array"==r(b))for(var f=0;f<b.length;f++)S(a,b[f],c,d,e);else{d=!!d;var h=O;b in h||(h[b]={k:0,p:0});h=h[b];d in h||(h[d]={k:0,p:0},h.k++);var h=h[d],g=t(a),k;h.p++;if(h[g])for(k=h[g],f=0;f<k.length;f++){if(h=k[f],h.C==c&&h.U==e){if(h.v)break;return}}else k=h[g]=[],h.k++;f=Va();f.src=a;h=new Ia;h.s(c,f,a,b,d,e);c=h.key;f.key=c;k.push(h);N[c]=h;P[g]||(P[g]=[]);P[g].push(h);a.addEventListener?a!=q&&a.Ta||a.addEventListener(b,f,d):a.attachEvent(b in R?R[b]:R[b]="on"+b,f)}else throw Error("Invalid event type");
}function Va(){var a=Wa,b=Na?function(c){return a.call(b.src,b.key,c)}:function(c){c=a.call(b.src,b.key,c);if(!c)return c};return b}function T(a,b,c,d,e){if("array"==r(b))for(var f=0;f<b.length;f++)T(a,b[f],c,d,e);else{d=!!d;a:{f=O;if(b in f&&(f=f[b],d in f&&(f=f[d],a=t(a),f[a]))){a=f[a];break a}a=null}if(a)for(f=0;f<a.length;f++)if(a[f].C==c&&a[f].ia==d&&a[f].U==e){Xa(a[f].key);break}}}
function Xa(a){if(N[a]){var b=N[a];if(!b.v){var c=b.src,d=b.type,e=b.wa,f=b.ia;c.removeEventListener?c!=q&&c.Ta||c.removeEventListener(d,e,f):c.detachEvent&&c.detachEvent(d in R?R[d]:R[d]="on"+d,e);c=t(c);if(P[c]){var e=P[c],h=Qa(e,b);0<=h&&K.splice.call(e,h,1);0==e.length&&delete P[c]}b.v=!0;if(b=O[d][f][c])b.ua=!0,Ya(d,f,c,b);delete N[a]}}}
function Ya(a,b,c,d){if(!d.L&&d.ua){for(var e=0,f=0;e<d.length;e++)d[e].v?d[e].wa.src=null:(e!=f&&(d[f]=d[e]),f++);d.length=f;d.ua=!1;0==f&&(delete O[a][b][c],O[a][b].k--,0==O[a][b].k&&(delete O[a][b],O[a].k--),0==O[a].k&&delete O[a])}}function Za(a,b,c,d,e){var f=1;b=t(b);if(a[b]){a.p--;a=a[b];a.L?a.L++:a.L=1;try{for(var h=a.length,g=0;g<h;g++){var k=a[g];k&&!k.v&&(f&=!1!==$a(k,e))}}finally{a.L--,Ya(c,d,b,a)}}return Boolean(f)}function $a(a,b){a.ha&&Xa(a.key);return a.handleEvent(b)}
function Wa(a,b){if(!N[a])return!0;var c=N[a],d=c.type,e=O;if(!(d in e))return!0;var e=e[d],f,h;if(!Na){var g;if(!(g=b))a:{g=["window","event"];for(var k=q;f=g.shift();)if(null!=k[f])k=k[f];else{g=null;break a}g=k}f=g;g=!0 in e;k=!1 in e;if(g){if(0>f.keyCode||void 0!=f.returnValue)return!0;a:{var l=!1;if(0==f.keyCode)try{f.keyCode=-1;break a}catch(u){l=!0}if(l||void 0==f.returnValue)f.returnValue=!0}}l=new M;l.s(f,this);f=!0;try{if(g){for(var n=[],z=l.currentTarget;z;z=z.parentNode)n.push(z);h=e[!0];
h.p=h.k;for(var p=n.length-1;!l.W&&0<=p&&h.p;p--)l.currentTarget=n[p],f&=Za(h,n[p],d,!0,l);if(k)for(h=e[!1],h.p=h.k,p=0;!l.W&&p<n.length&&h.p;p++)l.currentTarget=n[p],f&=Za(h,n[p],d,!1,l)}else f=$a(c,l)}finally{n&&(n.length=0)}return f}d=new M(b,this);return f=$a(c,d)}var ab;function bb(a,b){var c;c=a.className;c=s(c)&&c.match(/\S+/g)||[];for(var d=Ta(arguments,1),e=c.length+d.length,f=c,h=0;h<d.length;h++)0<=Qa(f,d[h])||f.push(d[h]);a.className=c.join(" ");return c.length==e}var cb=!D||D&&9<=Ha;
!E&&!D||D&&D&&9<=Ha||E&&J("1.9.1");D&&J("9");function db(a,b){Ka(b,function(b,d){"style"==d?a.style.cssText=b:"class"==d?a.className=b:"for"==d?a.htmlFor=b:d in eb?a.setAttribute(eb[d],b):0==d.lastIndexOf("aria-",0)||0==d.lastIndexOf("data-",0)?a.setAttribute(d,b):a[d]=b})}var eb={cellpadding:"cellPadding",cellspacing:"cellSpacing",colspan:"colSpan",frameborder:"frameBorder",height:"height",maxlength:"maxLength",role:"role",rowspan:"rowSpan",type:"type",usemap:"useMap",valign:"vAlign",width:"width"};
function fb(a,b,c){return gb(document,arguments)}function gb(a,b){var c=b[0],d=b[1];if(!cb&&d&&(d.name||d.type)){c=["<",c];d.name&&c.push(' name="',oa(d.name),'"');if(d.type){c.push(' type="',oa(d.type),'"');var e={};Ma(e,d);delete e.type;d=e}c.push(">");c=c.join("")}c=a.createElement(c);d&&(s(d)?c.className=d:"array"==r(d)?bb.apply(null,[c].concat(d)):db(c,d));2<b.length&&hb(a,c,b);return c}
function hb(a,b,c){function d(c){c&&b.appendChild(s(c)?a.createTextNode(c):c)}for(var e=2;e<c.length;e++){var f=c[e];if(!aa(f)||ba(f)&&0<f.nodeType)d(f);else{var h;a:{if(f&&"number"==typeof f.length){if(ba(f)){h="function"==typeof f.item||"string"==typeof f.item;break a}if("function"==r(f)){h="function"==typeof f.item;break a}}h=!1}Ra(h?Sa(f):f,d)}}}function ib(a,b){a.insertBefore(b,a.childNodes[0]||null)}function U(a){this.S=a||q.document||document}
U.prototype.Ra=function(a,b,c){return gb(this.S,arguments)};U.prototype.createElement=function(a){return this.S.createElement(a)};U.prototype.createTextNode=function(a){return this.S.createTextNode(a)};U.prototype.appendChild=function(a,b){a.appendChild(b)};
function jb(a,b){var c=a?new U(9==a.nodeType?a:a.ownerDocument||a.document):ab||(ab=new U),d=[];d.push("<!DOCTYPE html>");d.push("<html><head>",'<style>html,body{height:100%;margin:0;padding:0;}</style><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta charset="utf-8"><meta http-equiv="X-UA-Compatible" content="IE=edge">',"</head><body>",b,"</body></html>");c=c.Ra("iframe",{frameborder:0,style:'border:0;";//vertical-align:bottom;',src:'javascript:""'});a.appendChild(c);var d=
d.join(""),e=c.contentDocument||c.contentWindow.document;e.open();e.write(d);e.close();return c}
function V(a,b,c,d,e,f,h,g){this.log=function(){};g||(g={});g.waitForDOMLoaded=!0;if(g.inIframe||g.inFrameBuster)g.friendlyFrame=!0;na.call(this,e,d,f,c,g);this.a.o="closed";this.a.ga=!1;this.a.H=this.a.r();this.a.Na=this.a.na();this.a.h=this.a.H;this.a.Ca=["position:absolute;margin:0;padding:0;display:none;border:none;height:0;width:100%;height: 100%;z-index:2147483647;","position:absolute;margin:0;padding:0;display:block;border:none;width:100%;height: 100%;top: 0;left:0;z-index:2147483647;"];this.a.e=
null;this.a.b=null;this.a.ea=!1;this.$=function(){var a=this.a.n.clientWidth||this.a.Na;if(this.a&&(600<this.a.H||767<a))return!1;var a=!1,b=navigator.userAgent||navigator.vendor||window.opera;if(/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i.test(b)||
